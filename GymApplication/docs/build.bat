...
set JAVA_HOME="C:\Users\User\Programming Software\OpenJDK_winx64\jdk-11.0.10+9"
set JAVAFX_HOME="C:\Users\User\Programming Software\javafx-sdk-11.0.2"
...
javadoc --module-path %JAVAFX_HOME%\lib --add-modules=%JAVAFX_MODULES% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\JavaDocs %PRAC_SRC%\*.java
IF /I "%ERRORLEVEL%" NEQ "0" (
